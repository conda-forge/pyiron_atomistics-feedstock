...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_atomistics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_atomistics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron_atomistics
# for installing globally
pixi global install pyiron_atomistics
```
...
It is possible to list all of the versions of `pyiron_atomistics` available on your platform:
...
```
pixi search pyiron_atomistics --channel conda-forge
```
